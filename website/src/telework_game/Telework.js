...
import room from './assets/Background/room.jpeg'
import judge from './assets/Misc/judge.png'
import objection from './assets/Misc/objection.jpg'
import backgroundLeft from './assets/Background/background1.jpg'
import deskLeft from './assets/Background/desk1.png'
import backgroundRight from './assets/Background/background2.jpg'
import deskRight from './assets/Background/desk2.png'
import Tele_StandTalk from './assets/GIFS/MR. Telework/Stand_Talk.gif'
import Tele_ReadTalk from './assets/GIFS/MR. Telework/Read_Talk.gif'
import Tele_SlamTalk from './assets/GIFS/MR. Telework/Slam_Talk.gif'
import Tele_Slam from './assets/GIFS/MR. Telework/Slam.gif'
import Tele_SmirkTalk from './assets/GIFS/MR. Telework/Smirk_Talk.gif'
import Tele_ThinkStand from './assets/GIFS/MR. Telework/Think_Stand.gif'
import Tele_ThinkTalk from './assets/GIFS/MR. Telework/Think_Talk.gif'
import Tele_PointStart from './assets/GIFS/MR. Telework/Point_Start.gif'
import Tele_PointTalk from './assets/GIFS/MR. Telework/Point_Talk.gif'

import NoTele_ArmsCrossed from './assets/GIFS/Mr.No-Telework/Arms_Crossed.gif'
import NoTele_ArmsCrossedTalk from './assets/GIFS/Mr.No-Telework/Arms_Crossed_Talk.gif'
import NoTele_Cornered from './assets/GIFS/Mr.No-Telework/Cornered.gif'
import NoTele_DeskSlam from './assets/GIFS/Mr.No-Telework/Desk_Slam.gif'
import NoTele_DeskTalk from './assets/GIFS/Mr.No-Telework/Desk_Talk.gif'
import NoTele_PointTalk from './assets/GIFS/Mr.No-Telework/Point_Talk.gif'
import NoTele_StandTalk from './assets/GIFS/Mr.No-Telework/Stand_Talk (1).gif'
...
*/
const englishTexts = [
  { turn: 5, pose: "NA", background: 1, text: "June 30, 2025" },
  { turn: 5, pose: "NA", background: 1, text: "A court case is about to begin." },
  { turn: 5, pose: "NA", background: 1, text: "The judge, soon to enter, will sit at the center stage." },
  { turn: 5, pose: "NA", background: 1, text: "On one side, the defense attorney, Telework Wrights, stands ready to argue in favor of teleworking." },
  { turn: 5, pose: "NA", background: 1, text: "On the other side, the prosecutor, No-Telework, is prepared to present the case against it." },
  { turn: 4, pose: "NA", background: 1, text: "Order in the court! " },
  { turn: 4, pose: "NA", background: 1, text: "We are here today to debate the merits and drawbacks of teleworking. Mr. Wright, you may begin your opening statement." },
  ...
  { turn: 3, pose: "NA", background: 1, text: "..." },
  ...
  { turn: 4, pose: "NA", background: 1, text: "Could you elaborate further, Mr. No-Telework?" },
  ...
  { turn: 4, pose: "NA", background: 1, text: "Mr. No-Telework, do you have a rebuttal?" },
  ...
  { turn: 4, pose: "NA", background: 1, text: "So what do you propose Mr. Wrights?" },
  ...
  { turn: 4, pose: "NA", background: 1, text: "What do you think Mr.No-Telework?" },
  { turn: 2, pose: NoTele_Cornered, background: 1, text: "..." },
  { turn: 2, pose: NoTele_ArmsCrossed, background: 1, text: "..." },
  ...
  { turn: 4, pose: "NA", background: 1, text: "Let me give the verdict." },
  { turn: 4, pose: "NA", background: 1, text: "Teleworking shall be allowed!" },
  { turn: 5, pose: "NA", background: 1, text: "Let us telework?" },
];

const japaneseTexts = [
  { turn: 5, pose: "NA", background: 1, text: "2025年6月30日" },
  { turn: 5, pose: "NA", background: 1, text: "裁判が始まろうとしています。" },
  { turn: 5, pose: "NA", background: 1, text: "まもなく入廷する裁判官が中央に座ります。" },
  { turn: 5, pose: "NA", background: 1, text: "一方には、テレワークを支持する弁護士、テレワーク・ライツが立っています。" },
  { turn: 5, pose: "NA", background: 1, text: "もう一方には、テレワークに反対する検事、ノー・テレワークがいます。" },
  { turn: 4, pose: "NA", background: 1, text: "静粛に！" },
  { turn: 4, pose: "NA", background: 1, text: "本日はテレワークの利点と欠点について議論します。ライツさん、冒頭陳述をお願いします。" },
  { turn: 1, pose: Tele_ThinkStand, background: 1, text: "..." },
  ...
  { turn: 4, pose: "NA", background: 1, text: "ノー・テレワークさん、もう少し詳しく説明していただけますか？" },
  ...
  { turn: 4, pose: "NA", background: 1, text: "ノー・テレワークさん、反論はありますか？" },
  { turn: 2, pose: NoTele_DeskSlam, background: 1, text: "..." },
  ...
  { turn: 4, pose: "NA", background: 1, text: "ライツさん、あなたの提案は何ですか？" },
  ...
  { turn: 4, pose: "NA", background: 1, text: "ノー・テレワークさん、どう思いますか？" },
  { turn: 2, pose: NoTele_Cornered, background: 1, text: "..." },
  { turn: 2, pose: NoTele_ArmsCrossed, background: 1, text: "..." },
  ...
  { turn: 4, pose: "NA", background: 1, text: "判決を下します。" },
  { turn: 4, pose: "NA", background: 1, text: "テレワークを許可します！" },
  { turn: 5, pose: "NA", background: 1, text: "テレワークをさせてください？" },
];
...
function Telework({ language }) {
  ...
  if (showNextComponent) {
    ...
    return (
        ...
        >
            <div style={{ backgroundColor: 'lightblue', flex: 1, height: '50vw', width: '100vw', position: 'relative'}}>
              <img alt="asd" src={backgroundLeft} style={{height: '100%', width: '100%'}}/>
              <img alt="asd" src={textArray[currentIndex].pose} style={{position: 'absolute', bottom: '20px', left: '0%', height: '95%', width: '75%'}}></img>
              <img alt="asd" src={deskLeft} style={{position: 'absolute', bottom: '0%', left: '0%', width:'90%', height: '100%'}}></img>
              <div style={{ position: 'absolute', backgroundColor: 'black', left: '0px', bottom: '75px', width:'8%', height:'12%', textAlign: 'center'}}> 
                  <h4 style={{ color: 'white' }}>Telework Wrights</h4>
              </div>
              <Dialog>
    ...
    return (
        ...
        >
          <div style={{ backgroundColor: 'lightblue', flex: 1,  height: '50vw', width: '100vw', position: 'relative' }}>
            <img alt="asd" src={backgroundRight} style={{height: '100%', width: '100%'}}/>
            <img alt="asd" src={textArray[currentIndex].pose} style={{position: 'absolute', bottom: '0px', right: '0%', height: '95%', width: '75%'}}></img>
            <img alt="asd" src={deskRight} style={{position: 'absolute', bottom: '0%', right: '0%', width:'90%', height: '100%'}}></img>
            <div style={{ position: 'absolute', backgroundColor: 'black', bottom:'75px', width:'8%', height:'12%', textAlign: 'center'}}> 
                <h4 style={{ color: 'white' }}>No-Telework</h4>
            </div>
          <Dialog>
    ...
    return (
        ...
        >
          <div style={{ backgroundColor: 'lightblue', flex: 1, height: '50vw', width: '100vw', position: 'relative' }}>
            <img alt="asd" src={objection} style={{height: '100%', width: '100%'}}/>
          </div>
        </Box>
    )
  }
    ...
    return (
        ...
        >
          <div style={{ backgroundColor: 'lightblue', flex: 1, height: '50vw', width: '100vw', position: 'relative' }}>
            <img alt="asd" src={judge} style={{ height: '100%', width: '100%' }}/>
            <div style={{ position: 'absolute', backgroundColor: 'black', width:'8%', height:'12%', bottom: '75px', textAlign: 'center' }}> 
                  <h4 style={{ color: 'white' }}>Judge</h4>
              </div>
            <Dialog>
              <h4 style={{ color: 'white', opacity: 1 }}>
                {displayedText}
    ...
    return (
        ...
        >
          <div style={{ backgroundColor: 'lightblue', flex: 1, height: '50vw', width: '100vw', position: 'relative' }}>
            <img alt="asd" src={room} style={{ height: '100%', width: '100%' }}/>
            <Dialog>
              <h4 style={{ color: 'white', opacity: 1 }}>
                {displayedText}
              </h4>
